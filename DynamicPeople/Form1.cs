...
namespace DynamicPeople
{
    public partial class Form1 : Form
    {
        ...
        private void TeacherButton__Click(object sender, EventArgs e)
        {
            ...
            {
                if (keyValuePair.Value is Teacher)
                {
        ...
        private void StudentButton__Click(object sender, EventArgs e)
        {
            ...
            foreach (KeyValuePair<string, Person> keyValuePair in Globals.people.sortedList)
            {
                if (keyValuePair.Value is Student)
                {
                    AddPanel(keyValuePair.Value);
                }
        ...
        private void AddPersonToPanel(ref Panel panel1, Person person)
        {
            ...
            GroupBox photoGroupBox = new GroupBox();
            ...
            toolStrip1.Size = new System.Drawing.Size(177, 25);
            ...
            toolStripLabel1.Click += new EventHandler(ToolStripLabel1__Clicked);
            toolStripLabel1.Tag = panel1;
            // 
            // emailLabel
            // 
            emailLabel.Location = new System.Drawing.Point(4, 29);
            ...
            photoGroupBox.Location = new System.Drawing.Point(7, 45);
            photoGroupBox.Name = "photoGroupBox";
            photoGroupBox.Size = new System.Drawing.Size(114, 84);
            ...
            photoPictureBox.Size = new System.Drawing.Size(108, 65);
        ...
        private void ToolStripButton1__Click(object sender, EventArgs e)
        {
            ...
            if (tsb.Checked)
            {
                ...
                p.Size = new System.Drawing.Size(25, 159);
            }
            else
            {
        ...
        private void ToolStripLabel1__Clicked(object sender, EventArgs e)
        {
