...
namespace Dyscord
{
    ...
    public partial class DyscordForm : Form
    {
        ...
        private void LoginButton__Click(object sender, EventArgs e)
        {
            ...
            {
                webBrowser1.Navigate("https://people.rit.edu/dxsigm/php/login.php?login=" + userTextBox.Text + "&ip=" + myIp + ":" + myPort);
        ...
        {
            webBrowser1.Navigate("https://people.rit.edu/dxsigm/php/login.php?logins");
        ...
        private void SendButton__Click(object sender, EventArgs e)
        {
            if (this.targetIp.Length > 0)
            {
                ...
                Stream netStream = new NetworkStream(serverSocket);
                StreamWriter writer = new StreamWriter(netStream);

                string msg = userTextBox.Text + ": " + messageTextBox.Text;
                ...
                this.convoRichTextBox.Text += "> " + this.targetUser + ": " + messageTextBox.Text + "\n";
