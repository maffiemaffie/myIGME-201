    ...
    public partial class LinkedList : Form
    {
       ...
       */
        ...
        private void Button3__Click(object sender, EventArgs e)
        {
            ...
            // 2. Your code here
            sentence = ("the fox jumped over the dog").Split(' ');
            ...
            linkedList.AddBefore(new LinkedListNode<object>("quick"), linkedListNode);
            linkedList.AddBefore(new LinkedListNode<object>("brown"), linkedListNode);
