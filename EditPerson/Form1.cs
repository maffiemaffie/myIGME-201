    ...
    public partial class PersonEditForm : Form
    {
        ...
        private void TypeComboBox__SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if(cb.SelectedIndex == 0 )
            {
                ...
                // set classGroupBox Visible field = true
                this.classGroupBox.Visible = true;
                this.classGroupBox.Enabled = true;
            }
            else
            {
        ...
        private void OkButton__Click(object sender, EventArgs e)
        {
            ...
            if (himRadioButton.Checked) person.eGender = genderPronoun.him;
            if (herRadioButton.Checked) person.eGender = genderPronoun.her;
            if (themRadioButton.Checked) person.eGender = genderPronoun.them;

            if ( person.GetType() == typeof( Student))
            {
                student.gpa = Convert.ToDouble(this.gpaText.Text);

                if (froshRadioButton.Checked) student.eCollegeYear = collegeYear.freshman;
                if (sophRadioButton.Checked) student.eCollegeYear = collegeYear.sophomore;
                if (juniorRadioButton.Checked) student.eCollegeYear = collegeYear.junior;
                if (seniorRadioButton.Checked) student.eCollegeYear = collegeYear.senior;
            }
            else
            {
        ...
        private void ClassRadioButton__CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (rb.Checked)
            {
                ...
                switch (rb.Name)
                {
                    case "froshRadioButton":
                        classYear = 23;
                        break;
                    case "sophRadioButton":
                        classYear = 22;
                        break;
                    case "juniorRadioButton":
                        classYear = 21;
                        break;
                    default:
                        classYear = 20;
                ...
                this.classOfLabel.Text = "Class of 20" + classYear;
            }
        }
    }
}