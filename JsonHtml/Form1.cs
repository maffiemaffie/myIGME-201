...
namespace JsonHtml
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            {
                if (kvp.Value is Teacher) teachers.Add((Teacher)kvp.Value);
                if (kvp.Value is Student) students.Add((Student)kvp.Value);
            }
            ...
            string url = "https://people.rit.edu/dxsigm/json.php";
